...
function useAvailableActionsAndTriggers() {
    ...
    useEffect(() => {
      ...
      // Using Promise.all to handle both requests together
      Promise.all([
        axios.get(`${BACKEND_URL}/api/v1/trigger/available`),
        axios.get(`${BACKEND_URL}/api/v1/action/available`)
      ])
        .then(([triggersResponse, actionsResponse]) => {
          console.log('Trigger response:', triggersResponse.data);
          console.log('Action response:', actionsResponse.data);
          
          setAvailableTriggers(triggersResponse.data || []);
